...
def load_llff_data(basedir, factor=8, recenter=True, bd_factor=.75, spherify=False, path_zflat=False, split_train_val = 0):
...
#             zloc = np.percentile(tt, 10, 0)[2]
        ...
        # Generate poses for spiral path in video rneder
    ...
    if split_train_val == 0:
        ...
        return train_poses, reference_depth, reference_view_id, render_poses, poses
